...
public class RefiningRecipe implements Recipe<SimpleInventory> {
    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public RefiningRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<RefiningRecipe> {
        ...
        public RefiningRecipe read(Identifier id, JsonObject json) {
            ...
            return new RefiningRecipe(id, output, inputs);
        }
