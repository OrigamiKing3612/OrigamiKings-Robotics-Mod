...
public class ItemRegistry {
    ...
    public static final ShockwaveTransformedItem SHOCKWAVE_TRANSFORMED = registerItem(OrmMain.MOD_ID, "shockwave_transformed", new ShockwaveTransformedItem(new OrigamiItemSettings().maxCount(1)));
