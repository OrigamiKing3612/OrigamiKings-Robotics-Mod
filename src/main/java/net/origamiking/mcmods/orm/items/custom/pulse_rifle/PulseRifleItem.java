package net.origamiking.mcmods.orm.items.custom.pulse_rifle;
...
import net.origamiking.mcmods.orm.items.custom.pulse_rifle.renderer.PulseRifleItemRenderer;
...
public class PulseRifleItem extends RangedWeaponItem implements GeoItem {
    ...
    public PulseRifleItem(Settings settings) {
        super(settings);
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private PulseRifleItemRenderer renderer;

            @Override
            public BuiltinModelItemRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new PulseRifleItemRenderer();
