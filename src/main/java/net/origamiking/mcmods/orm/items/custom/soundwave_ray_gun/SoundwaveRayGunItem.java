package net.origamiking.mcmods.orm.items.custom.soundwave_ray_gun;
...
import net.origamiking.mcmods.orm.items.custom.soundwave_ray_gun.renderer.SoundwaveRayGunRenderer;
...
public class SoundwaveRayGunItem extends RangedWeaponItem implements GeoItem, Vanishable {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private SoundwaveRayGunRenderer renderer;

            @Override
            public BuiltinModelItemRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new SoundwaveRayGunRenderer();
