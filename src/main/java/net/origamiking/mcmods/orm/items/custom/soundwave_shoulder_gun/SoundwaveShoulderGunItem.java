package net.origamiking.mcmods.orm.items.custom.soundwave_shoulder_gun;
...
import net.origamiking.mcmods.orm.items.custom.soundwave_shoulder_gun.renderer.SoundwaveShoulderGunRenderer;
...
public class SoundwaveShoulderGunItem extends RangedWeaponItem implements GeoItem, Vanishable {
    ...
    public SoundwaveShoulderGunItem(Settings settings) {
        super(settings);
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private SoundwaveShoulderGunRenderer renderer;

            @Override
            public BuiltinModelItemRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new SoundwaveShoulderGunRenderer();
