...
public class ModScreenHandlers {
    ...
    public static ScreenHandlerType<CompacterBlockScreenHandler> COMPACTER_BLOCK_SCREEN_HANDLER = ScreenUtils.registerScreenHandler(OrmMain.MOD_ID, "compacter.json", new ScreenHandlerType<>(CompacterBlockScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
