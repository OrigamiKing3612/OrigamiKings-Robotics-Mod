...
public class OrmRecipeProvider {
    ...
    public static void offerTransformerChestplate(RecipeExporter exporter, ItemConvertible output, ItemConvertible chip) {
    ...
    public static void offerTransformerLeggings(RecipeExporter exporter, ItemConvertible output, ItemConvertible chip) {
    ...
    public static void offerTransformerBoots(RecipeExporter exporter, ItemConvertible output, ItemConvertible chip) {
    ...
    public static void offerTransformerCar(RecipeExporter exporter, ItemConvertible car, ItemConvertible helmet, ItemConvertible chestplate, ItemConvertible leggings, ItemConvertible boots) {
    ...
    public static void offerChipRefiningRecipe(RecipeExporter exporter, RecipeCategory category, ItemConvertible output, int count) {
    ...
    public static void transformerRecipes(RecipeExporter exporter, ItemConvertible helmet, ItemConvertible chestplate, ItemConvertible leggings, ItemConvertible boots, ItemConvertible car, ItemConvertible chip) {
