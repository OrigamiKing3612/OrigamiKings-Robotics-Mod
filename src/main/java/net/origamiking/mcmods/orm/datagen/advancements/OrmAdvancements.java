...
import net.origamiking.mcmods.orm.advancements.WelcomeCriteria;
...
public class OrmAdvancements implements Consumer<Consumer<Advancement>> {
    @Override
    public void accept(Consumer<Advancement> advancementConsumer) {
        Advancement welcome = Advancement.Builder.create().display(EnergonBlocks.ENERGON_BLOCK, Text.translatable(translatableTitle("welcome")), Text.translatable(translatableDescription("welcome")), new Identifier(OrmMain.MOD_ID, "textures/block/energon_block.png"), AdvancementFrame.TASK, true, true, false).criterion("welcome", new WelcomeCriteria.Condition()).build(advancementConsumer, OrmMain.MOD_ID + "/welcome");

        Advancement energon = Advancement.Builder.create().parent(welcome).display(EnergonItems.ENERGON, Text.translatable(translatableTitle("energon")), Text.translatable(translatableDescription("energon")), null, AdvancementFrame.TASK, true, true, false).criterion("get_energon", InventoryChangedCriterion.Conditions.items(EnergonItems.ENERGON)).build(advancementConsumer, OrmMain.MOD_ID + "/energon");
        Advancement spark = Advancement.Builder.create().parent(energon).display(RandomItems.SPARK, Text.translatable(translatableTitle("spark")), Text.translatable(translatableDescription("spark")), null, AdvancementFrame.TASK, true, true, false).criterion("get_spark", InventoryChangedCriterion.Conditions.items(RandomItems.SPARK)).build(advancementConsumer, OrmMain.MOD_ID + "/spark");

        Advancement ore_13 = Advancement.Builder.create().parent(energon).display(Ore13Items.ORE_13, Text.translatable(translatableTitle("ore_13")), Text.translatable(translatableDescription("ore_13")), null, AdvancementFrame.TASK, true, true, false).criterion("get_ore_13", InventoryChangedCriterion.Conditions.items(Ore13Items.ORE_13)).build(advancementConsumer, OrmMain.MOD_ID + "/ore_13");

        Advancement transformium = Advancement.Builder.create().parent(ore_13).display(TransformiumItems.TRANSFORMIUM, Text.translatable(translatableTitle("transformium")), Text.translatable(translatableDescription("transformium")), null, AdvancementFrame.TASK, true, true, false).criterion("get_transformium", InventoryChangedCriterion.Conditions.items(TransformiumItems.TRANSFORMIUM)).build(advancementConsumer, OrmMain.MOD_ID + "/transformium");

        Advancement dark_energon = Advancement.Builder.create().parent(energon).display(EnergonItems.DARK_ENERGON, Text.translatable(translatableTitle("dark_energon")), Text.translatable(translatableDescription("dark_energon")), null, AdvancementFrame.TASK, true, true, false).criterion("get_dark_energon", InventoryChangedCriterion.Conditions.items(EnergonItems.DARK_ENERGON)).build(advancementConsumer, OrmMain.MOD_ID + "/dark_energon");
