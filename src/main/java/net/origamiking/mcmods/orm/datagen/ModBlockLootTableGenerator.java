...
public class ModBlockLootTableGenerator extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(PolishedTransformiumBlocks.POLISHED_TRANSFORMIUM_BLOCK);
        addDrop(PolishedTransformiumBlocks.POLISHED_TRANSFORMIUM_STAIRS);
        addDrop(PolishedTransformiumBlocks.POLISHED_TRANSFORMIUM_SLAB, slabDrops(PolishedTransformiumBlocks.POLISHED_TRANSFORMIUM_SLAB));
        addDrop(PolishedTransformiumBlocks.POLISHED_TRANSFORMIUM_WALL);
