...
public class ShapedRecipes {
    public static void get(Consumer<RecipeJsonProvider> exporter) {
        ...
        //compacter
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, RegisterCompacterBlock.COMPACTER_BLOCK, 1)
                ...
                .offerTo(exporter, new Identifier(RecipeProvider.getRecipeName(RegisterCompacterBlock.COMPACTER_BLOCK)));
        //refinery
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, RegisterRefineryBlock.REFINERY_BLOCK, 1)
                .pattern("OIO").pattern("SSS")
                .input('S', Blocks.SMOOTH_STONE).input('I', Items.IRON_INGOT).input('O', Ore13Items.ORE_13)
                .criterion(RecipeProvider.hasItem(Blocks.SMOOTH_STONE), RecipeProvider.conditionsFromItem(Blocks.SMOOTH_STONE))
                .criterion(RecipeProvider.hasItem(Items.IRON_INGOT), RecipeProvider.conditionsFromItem(Items.IRON_INGOT))
                .offerTo(exporter, new Identifier(RecipeProvider.getRecipeName(RegisterRefineryBlock.REFINERY_BLOCK)));
        //chip refinery
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, RegisterChipRefineryBlock.CHIP_REFINERY_BLOCK, 1)
                .pattern(" I ").pattern("TTT")
                .input('T', TransformiumBlocks.TRANSFORMIUM_BLOCK).input('I', Items.IRON_INGOT)
                ...
                .criterion(RecipeProvider.hasItem(Items.IRON_INGOT), RecipeProvider.conditionsFromItem(Items.IRON_INGOT))
                .offerTo(exporter, new Identifier(RecipeProvider.getRecipeName(RegisterChipRefineryBlock.CHIP_REFINERY_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, ItemRegistry.OPTIMUS_PRIMES_ION_CANNON, 1)
                ...
                .input('T', TransformiumItems.TRANSFORMIUM).input('I', Items.IRON_INGOT).input('E', EnergonItems.ENERGON).input('O', Ore13Items.ORE_13)
