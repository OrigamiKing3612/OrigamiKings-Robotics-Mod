...
public class Skystrike extends ArmorUtils {
    ...
    public static final SkystrikeCarArmorItem JET = registerItem("skystrike_jet", new SkystrikeCarArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
