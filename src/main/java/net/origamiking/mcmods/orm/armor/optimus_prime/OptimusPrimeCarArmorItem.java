...
import net.origamiking.mcmods.orm.client.armor.renderer.optimus_prime.OptimusPrimeCarArmorRenderer;
...
public final class OptimusPrimeCarArmorItem extends ArmorItem implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            private OptimusPrimeCarArmorRenderer renderer;
...
//                return PlayState.STOP;
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    OptimusPrime.OPTIMUS_PRIME_CAR));
