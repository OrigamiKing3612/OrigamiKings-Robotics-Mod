...
public class Starscream extends ArmorUtils {
    ...
    public static final StarscreamJetArmorItem JET = registerArmor(OrmMain.MOD_ID, "starscream_jet", new StarscreamJetArmorItem(TransformerArmorMaterial.TRANSFORMER, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
