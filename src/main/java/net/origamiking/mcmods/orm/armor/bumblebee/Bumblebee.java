...
public class Bumblebee extends ArmorUtils {
    ...
    public static final BumblebeeCarArmorItem CAR = registerItem("bumblebee_car", new BumblebeeCarArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
