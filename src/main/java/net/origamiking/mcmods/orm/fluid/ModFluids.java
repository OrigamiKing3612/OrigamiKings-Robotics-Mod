...
import static net.origamiking.mcmods.oapi.items.ItemsUtils.registerBucketItem;
...
public class ModFluids extends FluidUtils {
    ...
    public static Item RAW_ENERGON_BUCKET = registerBucketItem(OrmMain.MOD_ID, "raw_energon_bucket", ModFluids.STILL_RAW_ENERGON);
    ...
    public static Item RAW_DARK_ENERGON_BUCKET = registerBucketItem(OrmMain.MOD_ID, "raw_dark_energon_bucket", ModFluids.STILL_RAW_DARK_ENERGON);
