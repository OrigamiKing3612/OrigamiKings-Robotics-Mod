package net.origamiking.mcmods.orm.fluid.oil;
...
public class OilFluid extends FlowableFluid {
    ...
    protected boolean canBeReplacedWith(FluidState state, BlockView world, BlockPos pos, Fluid fluid, Direction direction) {
        return state.getHeight(world, pos) >= 0.44444445f && fluid.isIn(ModFluidTags.RAW_ENERGON);
    }
    ...
    protected BlockState toBlockState(FluidState fluidState) {
        return ModFluids.OIL_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(fluidState));
    }
