...
public enum ModArmorMaterials implements StringIdentifiable, ArmorMaterial {
    TRANSFORMER("transformer", getOrmConfig().transformerArmorConfig.transformerDurabilityMultiplier, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        ...
        map.put(ArmorItem.Type.LEGGINGS, getOrmConfig().transformerArmorConfig.transformerLeggingsProtectionValue);
        map.put(ArmorItem.Type.CHESTPLATE, getOrmConfig().transformerArmorConfig.transformerChestplateProtectionValue);
        map.put(ArmorItem.Type.HELMET, getOrmConfig().transformerArmorConfig.transformerHelmetProtectionValue);
    }), getOrmConfig().transformerArmorConfig.transformerArmorEnchantability, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.0f, 0.2f, () -> Ingredient.ofItems(TransformiumItems.TRANSFORMIUM));
