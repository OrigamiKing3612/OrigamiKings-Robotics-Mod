...
public class RefineryRecipe implements Recipe<Inventory> {
    ...
    public RefineryRecipe(String group, Ingredient ingredient, ItemStack result) {
        this.type = ModRecipeType.REFINERY_RECIPE;
        this.serializer = ModRecipeSerializers.REFINING;
        this.group = group;
...
//        }
        ...
        @Override
        public RefineryRecipe read(PacketByteBuf packetByteBuf) {
        ...
        public static interface RecipeFactory {
            public RefineryRecipe create(String var1, Ingredient var2, Item var3, int var4);
        }
    }
}