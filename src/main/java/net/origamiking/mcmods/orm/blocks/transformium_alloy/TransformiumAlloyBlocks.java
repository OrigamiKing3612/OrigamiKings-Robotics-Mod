...
public class TransformiumAlloyBlocks extends BlocksUtils {
    ...
    public static final Block TRANSFORMIUM_ALLOY_WALL = registerBlock(OrmMain.MOD_ID, "transformium_alloy_wall", new WallBlock(OrigamiBlockSettings.copyOf(TransformiumAlloyBlocks.TRANSFORMIUM_ALLOY_BLOCK)));
    ...
    public static final Block TRANSFORMIUM_ALLOY_BRICK_WALL = registerBlock(OrmMain.MOD_ID, "transformium_alloy_bricks_wall", new WallBlock(OrigamiBlockSettings.copyOf(TransformiumAlloyBlocks.TRANSFORMIUM_ALLOY_BRICK_BLOCK)));
